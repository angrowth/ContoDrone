...
(async () => {
    ...
    const generateImage = [false, false, false, false, false, false, false];
    ...
    tables.forEach(async (table, index) => {
        ...
        for (const entity of entities[table]) {
            ...
            if (generateImage[index] && !("ImageURL" in entity)) {
                entity["ImageUrl"] = `https://raw.githubusercontent.com/angrowth/ContoDrone/main/assets/images/ProductID_${rowKey}.jpg`;
            }
